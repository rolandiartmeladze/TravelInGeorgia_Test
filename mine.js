...
var sawyisi_sigrdze = null;    var sawyisi_simagle = null; 
  var zoomin_max_sigrdze = null; var zoomin_mini_sigrdze = null;
    // var zoomin_max_simagle = null; // var zoomin_mini_simagle = null;
                                  ...
                                  contrast.addEventListener('click', ()=>{
                                        ...
                                        zoom_out.addEventListener('click', zoomout);
                                          ...
                                          download.addEventListener('click', ()=>{
                                            var imageUrl = player_img_active.src;
                                              var link = document.createElement("a");
                                                link.href = imageUrl;
                                                  var randomNum = Math.floor(Math.random() * 100000);
                                                    link.setAttribute("download", "T&G_" + data.gallery[index].Image);
                                                      link.click();
                                          });
